<template>
    <section class="white pb-5 pt-5">
                ...
                <v-flex md4 xs12>
                    <v-card class="elevation-0 transparent">
                        ...
                        <v-card-text class="grey--text  text--darken-2 font-weight-light">
                            ...
                            Easily update your menu, promotions, pricing, and more.
                        </v-card-text>
                    </v-card>
                </v-flex>
     ...
     <!--suppress HtmlUnknownTarget -->
                        ...
                        >
                        <v-card-text class="grey--text  text--darken-2 font-weight-light">
                            Gain valuable insights into consumer data including buying habits,
                            frequency, purchasing volume and other KPIs.
                        </v-card-text>
                    </v-card>
                </v-flex>
                <v-flex md4 xs12>
     ...
     <!--suppress HtmlUnknownTarget -->
                ...
                <v-flex md4 xs12>
                    <v-card class="elevation-0 transparent">
                        ...
                        >
                        <v-card-text class="grey--text  text--darken-2 font-weight-light">
                            Customer payments are deposited directly into your bank account in
                            real-time. with no commission fees or hidden fees.
                        </v-card-text>
                    </v-card>
                </v-flex>
                <v-flex md4 xs12>
                ...
                <v-flex md4 xs12>
                    <v-card class="elevation-0 transparent">
                        ...
                        >
                        <v-card-text class="grey--text  text--darken-2 font-weight-light">
                            Update your menu's items and pricing from the backoffice and your
                            mobile & web apps automatically update as well.
                        </v-card-text>
                    </v-card>
                </v-flex>
