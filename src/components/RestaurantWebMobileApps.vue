        ...
        <v-layout align-center row wrap>
          <v-flex xs12>
            <div class="text-xs-center ma-5 pt-5 pb-5">
              <div class="flex display-1 font-weight-light pb-3">
                Full Service Local Digital & Print Media Campaigns
              </div>
          ...
          <v-flex md4 xs12>
            <v-card>
              ...
              <v-card-title class="headline"
                >Neighborhood Mailers (DMM)
              </v-card-title>
              <v-card-text class="subheading grey--text text--darken-1">
                Attract new customers in the neighborhoods arounded your
          ...
          <v-flex md4 xs12>
            <v-card>
              ...
              <v-img
                ...
                contain
                src="/restaurant/restaurant-ad-campaigns.jpg"
              >
              </v-img>
              <v-card-title class="headline"
