                ...
                <v-row justify="center">
                    <v-col class="text-center pt-5 pb-5" cols="12">
                        ...
                        <div class="flex subheading font-weight-light">
                            Restaurant Image provides each advertiser with a Web app,
                            Android, and iOS mobile app, which is displayed to users when
                            they click on your listing. The apps are branded to your
                            restaurant and contain your address, store hours, a map, online
                            ordering capabilities, tracking and more.
                        </div>
                    </v-col>
                </v-row>
            </v-layout>
